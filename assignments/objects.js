...
const Kennan = {
  id:2, email:'kdiben1@tinypic.com', firstName:'Kennan', gender:'M', speak: 'Hello, my name is Kennan!',
}
...
const parent = {
  name: 'Susan', age: 70, speak: function(){return 'Hello, my name is '+this.name},
  child : {
    name: 'George', age:50, speak: function(){return 'Hello, my name is '+this.name},
    grandchild : {
      name: 'Sam', age:30, speak: function(){return 'Hello, my name is '+this.name},
    }
  }
}
